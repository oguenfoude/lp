  ...
  return (
    <section id="faq" className="py-12 md:py-16 bg-gradient-to-b from-white to-gray-50">
      <div className="container-custom max-w-3xl">
        <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center text-gray-900">الأسئلة الشائعة</h2>
...
function FAQItem({ q, a, index }: { q: string; a: string; index: number }) {
  ...
  return (
    <div className="bg-white border-2 border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-all">
      ...
      >
        <span className="text-base md:text-lg text-gray-900">{q}</span>
        <span className="text-2xl font-light flex-shrink-0 w-6 h-6 flex items-center justify-center text-gray-700">{open ? "−" : "+"}</span>
      </button>
      {open && (
        <div id={id} className="px-5 pb-4 text-base leading-relaxed text-gray-600 border-t border-gray-200 bg-gray-50">
